  ...
  ({ className, label, error, helper, ...props }, ref) => {
    ...
    return (
      <div className="w-full space-y-2">
        ...
        <textarea
          className={cn(
            "flex min-h-[120px] w-full rounded-xl border border-apsonic-border bg-apsonic-surface px-4 py-3 text-base text-apsonic-text placeholder:text-apsonic-subtle transition-colors resize-y",
